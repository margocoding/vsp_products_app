...
export function Header({ cartCount, onMenuToggle, onCartToggle, isMobileMenuOpen, searchQuery, onSearch }: HeaderProps) {
  return (
            ...
            <div className="flex items-center gap-3 min-w-[200px]">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0 hidden sm:block">
                  <h1 className="text-sm font-bold text-white tracking-tight">ООО «ЛСК-НН»</h1>
                  <p className="text-xs text-zinc-500 truncate">ЖД материалы ВСП</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="font-semibold text-sm text-white">+7 999 544 80 55</span>
                </div>
              </a>
