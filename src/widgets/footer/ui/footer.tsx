          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex items-start gap-3 text-zinc-400">
                <MapPin size={18} className="text-red-400/80 mt-0.5 flex-shrink-0" />
            ...
            <div>
              ...
              <div className="space-y-3">
                <a 
                  ...
                  className="flex items-center gap-3 text-zinc-400 hover:text-red-300 transition-colors duration-200 group"
                >
                  <Phone size={18} className="text-red-400/80 group-hover:text-red-300 flex-shrink-0" />
                ...
                <a 
                  ...
                  className="flex items-center gap-3 text-zinc-400 hover:text-red-300 transition-colors duration-200 group"
                >
                  <Mail size={18} className="text-red-400/80 group-hover:text-red-300 flex-shrink-0" />
