  ...
  return (
    <span
      className={cn(
        ...
        {
          default: 'bg-[rgba(255,255,255,0.05)] text-[#9CA3AF] border border-[rgba(255,255,255,0.1)]',
          used: 'bg-[rgba(245,158,11,0.15)] text-[#FBBF24] border border-[rgba(245,158,11,0.3)] shadow-[0_0_10px_rgba(245,158,11,0.1)]',
          new: 'bg-[rgba(16,185,129,0.15)] text-[#34D399] border border-[rgba(16,185,129,0.3)] shadow-[0_0_10px_rgba(16,185,129,0.1)]',
          available: 'bg-[rgba(255,43,43,0.15)] text-[#FF2B2B] border border-[rgba(255,43,43,0.3)] shadow-[0_0_10px_rgba(255,43,43,0.15)]',
